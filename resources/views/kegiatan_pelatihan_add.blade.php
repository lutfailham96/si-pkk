            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header bg-gradient-green">
                        <h3 class="mb-0 text-white">Tambah Kegiatan Pelatihan</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <form method="post" action="{{ route('kegiatan-pelatihan.store') }}">
                                    @csrf
                                    <div class="form-group">
                                        <label class="form-group-label">Kegiatan Pelatihan</label>
                                        <input class="form-control" type="text" placeholder="Budidaya Tanaman" value="{{ old('kegiatan_pelatihan') }}" name="kegiatan_pelatihan" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="datetime-local" value="{{ old('waktu') }}" name="waktu" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-group-label">Pemateri</label>
                                        <input class="form-control" type="text" placeholder="Tim Pemdes" value="{{ old('pemateri') }}" name="pemateri" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-group-label">Peserta</label>
                                        <input class="form-control" type="text" placeholder="Masyarakat RT 01 RW 01" value="{{ old('peserta') }}" name="peserta" required>
                                    </div>
